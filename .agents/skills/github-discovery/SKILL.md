...
- 仓库名包含 `skill`、`agent`、`Codex`、`codex` 等关键字
- README 中有 `SKILL.md`、`AGENTS.md`、`npx skills` 等字样
- 话题标签包含 `Codex`、`agent-skills`、`ai-agent`
- 作者是有名气的开发者或组织
...
- GitHub Topics: `Codex`、`agent-skills`、`ai-coding-agent`
